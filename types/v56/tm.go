...
type TmEdgeClusterTransportNodeStatus struct {
	...
	AvgDatapathCPUUsagePercentage int `json:"avgDatapathCpuUsagePercentage,omitempty"`
	// Average utilization of all the Service CPU cores in the system.
	AvgServiceCPUUsagePercentage int `json:"avgServiceCpuUsagePercentage,omitempty"`
	...
	DatapathMemoryUsagePercentage int `json:"datapathMemoryUsagePercentage,omitempty"`
	...
	SystemMemoryUsagePercentage int `json:"systemMemoryUsagePercentage,omitempty"`
