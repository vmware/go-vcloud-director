...
var endpointMinApiVersions = map[string]string{
	...
	types.OpenApiPathVersion1_0_0 + types.OpenApiEndpointEntityMetadata:                   "37.0", // VCD 10.3+
	types.OpenApiPathVersion1_0_0 + types.OpenApiEndpointEntityMetadataByEntryId:          "37.0", // VCD 10.3+
}
