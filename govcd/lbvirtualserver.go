...
func (egw *EdgeGateway) CreateLbVirtualServer(ctx context.Context, lbVirtualServerConfig *types.LbVirtualServer) (*types.LbVirtualServer, error) {
	...
	readVirtualServer, err := egw.GetLbVirtualServerById(ctx, lbVirtualServerId)
	if err != nil {
...
// name do not match.
func (egw *EdgeGateway) getLbVirtualServer(ctx context.Context, lbVirtualServerConfig *types.LbVirtualServer) (*types.LbVirtualServer, error) {
	if err := validateGetLbVirtualServer(lbVirtualServerConfig, egw); err != nil {
		return nil, err
	}

	vs, err := egw.GetLbVirtualServers(ctx)
	if err != nil {
		return nil, err
	}
...
func (egw *EdgeGateway) GetLbVirtualServers(ctx context.Context) ([]*types.LbVirtualServer, error) {
	httpPath, err := egw.buildProxiedEdgeEndpointURL(types.LbVirtualServerPath)
	if err != nil {
		return nil, fmt.Errorf("could not get Edge Gateway API endpoint: %s", err)
	}
...
func (egw *EdgeGateway) GetLbVirtualServerById(ctx context.Context, id string) (*types.LbVirtualServer, error) {
	return egw.getLbVirtualServer(ctx, &types.LbVirtualServer{ID: id})
}

// GetLbVirtualServerByName wraps getLbVirtualServers and needs only a Name for lookup
func (egw *EdgeGateway) GetLbVirtualServerByName(ctx context.Context, name string) (*types.LbVirtualServer, error) {
	return egw.getLbVirtualServer(ctx, &types.LbVirtualServer{Name: name})
}
...
// Name, Protocol, Port and IpAddress fields must be populated
func (egw *EdgeGateway) UpdateLbVirtualServer(ctx context.Context, lbVirtualServerConfig *types.LbVirtualServer) (*types.LbVirtualServer, error) {
	err := validateUpdateLbVirtualServer(lbVirtualServerConfig, egw)
	if err != nil {
		return nil, err
	}

	lbVirtualServerConfig.ID, err = egw.getLbVirtualServerIdByNameId(ctx, lbVirtualServerConfig.Name, lbVirtualServerConfig.ID)
	if err != nil {
	...
	readVirtualServer, err := egw.GetLbVirtualServerById(ctx, lbVirtualServerConfig.ID)
	if err != nil {
...
func (egw *EdgeGateway) DeleteLbVirtualServer(ctx context.Context, lbVirtualServerConfig *types.LbVirtualServer) error {
...
func (egw *EdgeGateway) DeleteLbVirtualServerById(ctx context.Context, id string) error {
	return egw.DeleteLbVirtualServer(ctx, &types.LbVirtualServer{ID: id})
}

// DeleteLbVirtualServerByName wraps DeleteLbVirtualServer and requires only Name for deletion
func (egw *EdgeGateway) DeleteLbVirtualServerByName(ctx context.Context, name string) error {
	return egw.DeleteLbVirtualServer(ctx, &types.LbVirtualServer{Name: name})
}
...
func (egw *EdgeGateway) getLbVirtualServerIdByNameId(ctx context.Context, name, id string) (string, error) {
	if name == "" && id == "" {
	...
	readLbVirtualServer, err := egw.GetLbVirtualServerByName(ctx, name)
	if err != nil {
