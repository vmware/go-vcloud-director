...
func (catalogItem *CatalogItem) GetVAppTemplate() (VAppTemplate, error) {
	...
	err := catalogItem.client.ExecuteRequest(catalogItem.CatalogItem.Entity.HREF, "GET",
...
func (catalogItem *CatalogItem) Delete() error {
	...
	return catalogItem.client.ExecuteRequestWithoutResponse(catalogItemHREF.String(), "DELETE",
