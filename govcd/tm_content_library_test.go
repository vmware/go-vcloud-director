...
// TODO: Tests missing: Tenant, subscribed catalog, shared catalog
...
func (vcd *TestVCD) Test_ContentLibraryProvider(check *C) {
	...
	clDefinition := &types.ContentLibrary{
		...
		AutoAttach:      true, // TODO: Test with false, still does not work
	...
	// "Computed" values
	check.Assert(createdCl.ContentLibrary.IsShared, Equals, true) // TODO: Still not used in UI
	check.Assert(createdCl.ContentLibrary.IsSubscribed, Equals, false)
	check.Assert(createdCl.ContentLibrary.LibraryType, Equals, "PROVIDER") // TODO: Test with Tenant once implemented
