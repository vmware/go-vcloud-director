...
func (vcdClient *VCDClient) GetAllIpDiscoveryProfiles(queryParameters url.Values) ([]*types.NsxtSegmentProfileTemplateIpDiscovery, error) {
	...
	return genericGetAllFilteredEntities[types.NsxtSegmentProfileTemplateIpDiscovery](&vcdClient.Client, endpoint, queryParameters, "IP Discovery Profiles")
}
...
func (vcdClient *VCDClient) GetAllMacDiscoveryProfiles(queryParameters url.Values) ([]*types.NsxtSegmentProfileTemplateMacDiscovery, error) {
	...
	return genericGetAllFilteredEntities[types.NsxtSegmentProfileTemplateMacDiscovery](&vcdClient.Client, endpoint, queryParameters, "MAC Discovery Profiles")
}
...
func (vcdClient *VCDClient) GetAllSpoofGuardProfiles(queryParameters url.Values) ([]*types.NsxtSegmentProfileTemplateSegmentSpoofGuard, error) {
	...
	return genericGetAllFilteredEntities[types.NsxtSegmentProfileTemplateSegmentSpoofGuard](&vcdClient.Client, endpoint, queryParameters, "Spoof Guard Profiles")
}
...
func (vcdClient *VCDClient) GetAllQoSProfiles(queryParameters url.Values) ([]*types.NsxtSegmentProfileTemplateSegmentQosProfile, error) {
	...
	return genericGetAllFilteredEntities[types.NsxtSegmentProfileTemplateSegmentQosProfile](&vcdClient.Client, endpoint, queryParameters, "QoS Profiles")
}
...
func (vcdClient *VCDClient) GetAllSegmentSecurityProfiles(queryParameters url.Values) ([]*types.NsxtSegmentProfileTemplateSegmentSecurity, error) {
	...
	return genericGetAllFilteredEntities[types.NsxtSegmentProfileTemplateSegmentSecurity](&vcdClient.Client, endpoint, queryParameters, "Segment Security Profiles")
}
