...
* Added ability to set specific catalog storage profile using `adminCatalog.Update()`, `adminCatalog.CreateWithStorageProfile()`, 
`catalog.CreateWithStorageProfile()`  [#344](https://github.com/vmware/go-vcloud-director/pull/344)
