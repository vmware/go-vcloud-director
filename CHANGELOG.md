...
* Added methods `vm.SetProductSectionList` and `vm.GetProductSectionList` [#235](https://github.com/vmware/go-vcloud-director/pull/235)
* Added methods `vapp.SetProductSectionList` and `vapp.GetProductSectionList` [#235](https://github.com/vmware/go-vcloud-director/pull/235)
